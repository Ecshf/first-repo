...
<%
	...
	String sql = "select uname from userinfo where username=\'"
			+ username + "\'";
	PreparedStatement preparedStatement = (PreparedStatement) JdbcUtils
		...
		<div class="loginbox registbox">
			<div class="login-content reg-content">
				...
				<form id="signupForm" action="CompletePersonalSuccessAction"
					...
					<div class="row">
						<%
							String sql3 = "select img from user where username=\'"
										+ username + "\'";
								PreparedStatement preparedStatement3 = (PreparedStatement) JdbcUtils
										.getConnection().prepareStatement(sql3);
								ResultSet rs3 = preparedStatement3.executeQuery();
								while (rs3.next()) {
						%>
						&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
						<img src="\Member\upload\<%=rs3.getString(1)%>" width="80" height="80">
...
<%
		...
		PreparedStatement preparedStatement2 = (PreparedStatement) connection2
