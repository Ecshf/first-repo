...
public class downloadAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		JsonObject json = ProductDao.updatePoint(point, username);
		String ProductID = request.getParameter("ProductID");
		int id = ProductDao.getProductid(Maps.getProductid(),ProductID);
		System.out.println("id:"+id);
		JsonObject json2 = ProductDao.addToBuyProduct(username, id);
		JsonObject json3 = ProductDao.updateProductUseNum(id);
