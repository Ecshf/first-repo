	...
	<div id="dlg" class="easyui-dialog"
		...
		<form id="fm" method="post" novalidate>
			<div class="fitem">
				...
				<span>卡号:<input type="text" name="CardNumber"></span>
				<br><br><br>
				<span>密码:<input type="password" name="CardPassword"></span>
				<br><br>
				<br> <span>需要用多少点数兑换积分? <select name="Point" id="Point"
					style="width:60px;">
				...
				<br> <span><font color="red">(1个点数可兑换10个积分)</font></span> <br>
			</div>
